...
public class CXMFilteredValueCount
{
  ...
  public String set_data_path;
  public String set_index_path;
  ...
  private void openFile()
  {
    try
    {
    	btree = new File(set_data_path+f_name+"_"+column_seq+".fdat");
    	index = new File(set_index_path+f_name+"_"+column_seq+".fidx");
    	if (new_check)
    	{
    		btree.delete();
    		index.delete();
