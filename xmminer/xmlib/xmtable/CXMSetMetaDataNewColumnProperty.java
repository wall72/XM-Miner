...
public class CXMSetMetaDataNewColumnProperty
{
  private String f_name;
  private String datatype = "datatype";
  private String column_list_key = "NEW_COLUMN_LIST";
  ...
  private String compute_default = "computed";
  ...
  private void readColumnProperty()
  {
    ...
    for (int i=0; i<column_list.length; i++)
    {
      ...
      data_type_value = cmr2.getProfiles(column_list_value[0]+type_key);
