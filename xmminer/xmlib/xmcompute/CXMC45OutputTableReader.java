...
public class CXMC45OutputTableReader
{
  ...
  public CXMC45OutputTableReader()
  {
  }
  ...
  public void setFileStatus(String project_name, String arc_name, boolean test_flag)
  {
     ...
     set_data_path = root_path + project + index_path;
     f_name = arc_name;
     t_flag = test_flag;
     getArcMetaData();
     fileOpen();
  ...
  private void fileOpen()
  {
      try
      {
          if (t_flag)
          {
              result = new File(set_data_path+f_name+"_c45_rtf.data");
              result_index = new File(set_index_path+f_name+"_c45_rtf.cidx");
          }
          else
          {
              result = new File(set_data_path+f_name+"_c45_rlf.data");
              result_index = new File(set_index_path+f_name+"_c45_rlf.cidx"); 
          }
